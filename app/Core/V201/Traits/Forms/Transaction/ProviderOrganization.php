...
trait ProviderOrganization
{
    ...
    {
        return $this->addCollection('provider_organization', 'Activity\Transactions\ProviderOrganization', 'provider-org hidden', [], trans('elementForm.provider_organisation'));
    }
}
