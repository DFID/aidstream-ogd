...
class Location extends BaseForm
{
    ...
    public function buildForm()
    {
        $this
            ...
            ->addCollection('name', 'Activity\Name', 'hide-two location', [], trans('elementForm.location_name'))
            ->addCollection('location_class', 'Activity\LocationClass', 'hide-two loc-type', [], trans('elementForm.location_type'))
            ...
            ->addCollection('point', 'Activity\Point', 'points', [], trans('elementForm.point'))
