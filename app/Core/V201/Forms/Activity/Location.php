...
class Location extends BaseForm
{
    ...
    public function buildForm()
    {
        $this
            ...
            ->addCollection('name', 'Activity\Name', 'hide-two', [], trans('elementForm.location_name'))
            ->addCollection('location_class', 'Activity\LocationClass', 'hide-two', [], trans('elementForm.location_type'))
