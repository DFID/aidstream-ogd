...
class HumanitarianScopesOGD extends BaseForm
{
    ...
    {
        $this
            ->addCollectionHideLabel('humanitarian_scope_emergency', 'Activity\HumanitarianScopeEmergency', 'humanitarian_scope_emergency',[], trans('elementForm.humanitarian_scope_emergency'))
