    ...
    <div class="panel-body">
        <div class="create-form settings-form org-info-form">
            ...
            <div style="display: none" class="col-md-12 col-xs-12">
                {!! AsForm::text(['name'=>'secondary_reporter', 'class' => 'organization_name_abbr','value'=>"0",'label'=>trans('organisation.secondary_reporter'), 'parent'=>'col-xs-12 col-sm-6 col-md-6']) !!}
            </div>
            @endif
