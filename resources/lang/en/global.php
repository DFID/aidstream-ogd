...
return [
    ...
    'dont_have_account'                            => 'Don\'t have a DevFlow account?',
    ...
    'none_of_the_results_match_organisation_text'  => 'None of the results above match my organisation. I would like to <a href=":url">register</a> my organisation for an DevFlow account.',
    ...
    'seems_there_are_similar_organisations'        => 'It seems there are account(s) on DevFlow with same/similar organisation name you have entered during registration. To help us recover your account details,please enter the name of your organisation in the field below.',
    ...
    'aidstream_supports_multiple'                  => '<p>DevFlow supports <strong>multiple user accounts</strong> for an organisation.</p><span class="multi-user-info">You can add multiple users once your account is set up, or you can </span><span id="add-user">add additional users now.</span>',
    ...
    'thank_you_for_choosing_aidstream'             => 'Thank you for choosing DevFlow to publish your organisation\'s data to the IATI Registry.',
